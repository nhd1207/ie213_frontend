                ...
                <Row gutter={16}>
                  <Col span={12}>
                    <Statistic
                      ...
                      prefix={
                        <UserOutlined
                          className={`${style.userIcon} ${style.iconPrefix}`}
                        />
                      }
                    />
                    <Statistic
                      ...
                      value={
                        props?.adminData?.user?.filter((item) => {
                          return item.active === true;
                        }).length
                      }
                      prefix={
                          ...
                          >
                            {dataUser.map((entry, index) => (
                              <Cell
                                label={renderCustomizedLabel}
                                key={`cell-${index}`}
                                fill={COLORSUSER[index % COLORSUSER.length]}
                              />
                            ))}
                          </Pie>
                          <Label></Label>
                ...
                <Row gutter={16}>
                  <Col span={12}>
                    <Statistic
                      ...
                      prefix={
                        <WalletOutlined
                          className={`${style.accessoryBillIcon} ${style.iconPrefix}`}
                        />
                      }
                    />
                    <Button
                    ...
                    <Statistic
                      ...
                      prefix={
                        <EditOutlined
                          className={`${style.postIcon} ${style.iconPrefix}`}
                        />
                      }
                    />
                    <Button
